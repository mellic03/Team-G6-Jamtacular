class UI {
    ...
    draw() {
        ...
        // health bar
        fill(0, 255, 0);
        rect(73, 25, this.owner.health, 20);
        fill(255);
        text(round(this.owner.health, 0), 50, 25);

        // ammo bar
        fill(255, 255, 0);
        rect(50, 50, this.owner.rangedWeapon.ammo, 20);
        fill(255);
        text(round(this.owner.rangedWeapon.ammo, 0), 50, 50);
        ...
        if (this.owner.GRAPPLE){
            if (this.owner.grapple.grappled){
                image(this.owner.grapple_open_img, 110, 100);
            }else{
                image(this.owner.grapple_closed_img, 110, 100);
            }
        }
        if (this.owner.RANGED){
            image(this.owner.rangedImg, 110, 100);
        }
    ...
    mainMenu() {
        ...
        this.button("START GAME", width/2, height/2, 130, 50, this.MAIN_GAME);
    }
    ...
    deathScreen() {
        ...
        //  button(str, x, y, w, h, state)
        this.button("RESTART GAME", width/2, height/2, 130, 50, this.RESTART);
